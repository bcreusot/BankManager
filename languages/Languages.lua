...
language = {
	...
	Deutsch = {
		...
		subMenuRules 					= "Einlagern / Entnehmen",
		subMenuRulesButtonTooltip 		= "Regeln für dieses Profil festlegen",
        ...
        rawsWarning 					= "Rohmaterialien werden nicht verschoben wenn sie auf - gesetzt sind.\n<<Passend>> wird die gleiche Regel auf das Rohmaterial anwenden wie beim entsprechenden Handwerk",
